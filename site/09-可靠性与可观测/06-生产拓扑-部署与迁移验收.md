...
生产拓扑把不同生命周期的工作分开：Application Server 接收和展示任务，Queue 调节速率，Worker 在租约与预算下推进 Run，Store 持有领域事实与恢复证据，Tool Gateway 控制外部能力，OTel 连接因果链。Health、Drain、Fencing、Schema Migration、Canary 与 Manual Takeover 共同保证系统能在发布和故障中继续解释真实状态。完成这些验收后，Resolution Desk 才从“可运行 Demo”进入“可运营系统”。
