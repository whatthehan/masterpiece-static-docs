...
5. 完成第 06 部分 01–04 以及第 07 部分 01–04，依次加入 Context、Knowledge、Memory、Tool、MCP 与受控行动；06/05 的 Agentic RAG / GraphRAG 留作进阶对照实验；
...
9. 用第 09 部分补齐恢复、可观测、发布门禁与受控改进闭环；
10. 在第 10 部分按“综合心智模型 → 自测 → 参考答案 → 八周构建路径 → Resolution Desk 总装”完成闭环。
